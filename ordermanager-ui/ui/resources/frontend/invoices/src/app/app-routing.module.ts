...
const routes: Routes = [
  ...
  { path: 'create-person-page', component: PersonFormComponent },
  { path: 'invoice-list-page', component: PrintinvoiceComponent },
  { path: 'invoice-management-page', component: InvoiceManagementComponent },
