...
@Component({
    ...
    imports: [CommonModule, ReactiveFormsModule, AngularIbanModule, ButtonModule, InputTextModule, MessageModule, ToastModule, SelectModule, DialogModule, TemplatesComponentComponent, TranslocoPipe],
